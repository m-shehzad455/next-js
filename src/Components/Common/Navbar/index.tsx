                ...
                <Menu as="div" className="relative ml-4 flex-shrink-0">
                  <div>
                    <Menu.Button className="flex rounded-full bg-white text-sm ">
                      ...
                      <span className="h-4 w-4  flex text-center justify-center absolute text-white rounded-full bg-red-500  top-0 right-0">
                        2
                      </span>
                    </Menu.Button>
                  </div>
                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-64 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      ...
                      {({ active }) => (
                          <a
                            ...
                            className={classNames(
                              active ? "bg-gray-100" : "",
                              "block  px-3  text-sm text-gray-700  py-3"
                              )}
                          > <h1 className="border-b-2 text-sm">PROJECT STATUS</h1>
                            {progress.map((items) => (
                              
                              <div className="text-sm flex justify-between">
                                
                                <div>
                                <h1 className="font-semibold font-900 py-2">{items.heading}</h1>
                                  <span className="w-3 "><Progressbar  /></span>
                                </div>
                  ...
                  <div>
                    <Menu.Button className=" relative flex rounded-full bg-white text-sm  focus:ring-indigo-500 focus:ring-offset-2">
                      <img
                        ...
                        alt=""
                      />
                      <span className="h-4 w-4  flex text-center justify-center absolute text-white rounded-full bg-red-500  absolute right-0 z-16 origin-top-right ">
                        2
                      </span>
                    </Menu.Button>
                  </div>
