...
//               <div className="flex flex-1 items-center justify-center px-2 lg:ml-14 lg:justify-between">
...
//                           >
//                             {" "}
//                             <h1 className="border-b-2 text-sm pb-2">CHANGE COUNTRY</h1>
      ...
      {({ open }) => (
        <>
          <div className="relative z-10 bg-white shadow">
            <div className="mx-auto flex  px-4 py-2 sm:px-6 ">
              <Popover.Button
                className={classNames(
          ...
          >
            <Popover.Panel className="absolute  transform shadow-lg">
              <div className="absolute inset-0 flex" aria-hidden="true">
               
              </div>
              <div className="relative mx-auto grid ">
                <nav
                  className="grid bg-white px-4 py-8 sm:grid-cols-2 sm:gap-x-8 sm:py-12 sm:px-6 "
